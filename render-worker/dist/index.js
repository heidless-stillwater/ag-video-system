...
app.post('/render', async (req, res) => {
    ...
    try {
        ...
        // Trigger render
        const finalUrl = await render_engine_1.renderEngine.renderDocumentary(projectId, payload.scenes, payload.backgroundMusicUrl, payload.backgroundMusicVolume, payload.ambianceUrl, payload.ambianceVolume, payload.narrationVolume, payload.globalSfxVolume, payload.subtitlesEnabled, payload.subtitleStyle, payload.aspectRatio, payload.customFileName, payload.performanceProfile, onProgress);
        // Update final status
        await admin.firestore().collection('projects').doc(projectId).update({
